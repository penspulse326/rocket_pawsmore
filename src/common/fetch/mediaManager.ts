import apiNext from '@/common/constants/nextApi';
...
export const mediaUpload = async (file: File, tag: TagType): Promise<ResponseType> => {
...
export const mediaDelete = async (publicId: string, resourceType: 'image' | 'video') => {
  return new Promise(async (resolve, reject) => {
    try {
