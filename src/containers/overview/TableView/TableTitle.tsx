...
const TableTitle: React.FC<TableTitleProps> = ({ cardType }) => {
  ...
  const Daily = () => {
    ...
    return (
      <div className="flex">
        <div className="w-[116px] font-semibold pl-4 self-end pb-2">日期</div>
        {/* 一般 */}
        <div className="flex flex-col gap-y-2 border-l border-stroke pb-2">
          <span className="text-note pl-4">{routine.category}</span>
        ...
        {/* 異常 */}
        <div className="flex flex-col gap-y-2 border-l border-stroke pb-2">
          <span className="text-note pl-4">{abnormal.category}</span>
          <ul className="flex gap-x-2 px-4">
        ...
        <div className="flex flex-col gap-y-2 border-x border-stroke pb-2">
          <span className="text-note pl-4">{dailyCares.category}</span>
          <ul className="flex gap-x-2 px-4">
        ...
        {/* 備註 */}
        <div className="max-w-[228px] w-full font-semibold px-4 self-end pb-2">
          備註
        </div>
      </div>
    );
  ...
  const Medical = () => {
    return (
      <div className="flex h-16">
        <div className="w-[116px] font-semibold px-4 self-end pb-2">日期</div>
        <ul className="flex gap-x-2 font-semibold pl-4 pb-2 border-l border-stroke h-full">
  ...
  const Moment = () => {
    return (
      <div className="flex h-16">
        <div className="w-[116px] font-semibold px-4 self-end pb-2">日期</div>
        <ul className="flex gap-x-8 font-semibold pl-4 pb-2 border-l border-stroke h-full">
