import { sickCategory } from '@/common/constants/formText';
  ...
  return (
    <ul className='mt-2 flex flex-col gap-4'>
      {dataSet.map(([NAME, { TITLE, INPUT_TYPE, OPTIONS }]) => {
        const listItemClass = NAME === 'symptom' ? 'items-start' : 'items-center h-8';
        const containerClass = NAME === 'symptom' ? 'items-start' : 'items-center';
